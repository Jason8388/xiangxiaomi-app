...
info "预计总耗时：3-5 分钟"
info "步骤说明："
info "  [0/5] 删除 Android 目录（禁用 Coze 自动 Android 构建）"
info "  [1/5] 安装 Node 依赖"
...
# ==================== 复制 Client 静态资源 ====================
info "[4/5] 复制 Client 静态资源到 Server..."
...
info ""
info "说明："
info "  - 已禁用 Android 构建（通过删除 client/android/ 目录）"
info "  - 仅部署 Web 端应用"
info "  - Android 应用需要通过 EAS Build 单独构建"
info ""
