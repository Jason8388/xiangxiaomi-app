        ...
        <PCCard>
          <PCToolbar 
            ...
            right={<>
              ...
              <button className="pc-btn pc-btn-default" style={{ marginRight: 8, background: '#E8F5E9', color: '#1E88E5', border: '1px solid #1E88E5' }} onClick={() => window.open(`${API_BASE}/api/v1/knowledge/export`, '_blank')}>
